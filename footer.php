	...
	<div id="footer-wrap">
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="footer-bottom">
				<div class="site-info">
					<p>&copy;<?php echo date('Y'); ?> <strong>HYGIEIA</strong> | <a href="<?php echo get_permalink(49); ?>">Privacy Policy</a> |  <span class="ce"><?php echo file_get_contents(get_bloginfo('template_directory'). '/img/c-e.svg'); ?></span> | d-Nav&trade; is not available in the US</p>
				</div><!-- .site-info -->
			</div>
		</footer><!-- #colophon -->
	</div><!-- #footer-wrap -->
